...
points(gsp, col="violetred1", cex=1.0,pch =19) 

# df.gsp <- data.frame(gsp)
# groups <-  split(df.gsp, clust)
# 
# points(groups$`1`, col="turqoise1", cex=1.3,pch =19) 
# points(groups$`2`, col="orchid4", cex=1.3,pch =19)
# points(groups$`3`, col="lightcoral", cex=1.3,pch =19)
