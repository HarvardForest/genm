...
plot(c(lon, lon), c(lat, lat), mar=par("mar"), xlab="longitude", ylab="latitude", xaxt="n", yaxt="n", type="n", main="Joshua tree presence data")
...
#crop data
YbrevRange = extent(leftlon, rightlon,lowerlat, upperlat) # define the extent
